...
#' Maximalen Umfang der Datenbankabfrage für BPatG bestimmen.
#' 
...
f.scope  <- function(debug.toggle = FALSE,
    ...
    url.year <- paste0("https://juris.bundespatentgericht.de/cgi-bin/rechtsprechung/list.py?Gericht=bpatg&Art=en&Datum=",
                       year)
...
#' @param x Character. Ein Vektor aus URLs der BPatG-Datenbank für ein bestimmtes Jahr.
