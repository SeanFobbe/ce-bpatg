...
output:
  pdf_document:
    ...
    includes:
      in_header: markdown/Preamble_DE.tex
...
tar_option_set(packages = c("RcppTOML",     # TOML-Dateien lesen und schreiben
...
# Kompilierung der vollen Pipeline
...
kable(tar_meta(fields = "time", complete_only = TRUE),
      format = "latex",
      align = "r",
      booktabs = TRUE,
