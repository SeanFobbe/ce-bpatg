...
output:
  pdf_document:
    ...
    includes:
      ...
      before_body: [temp/CE-BPatG_Definitions.tex, tex/CE-BPatG_Titlepage_Compilation.tex]
...
values <- list(
  name = as.list(as.symbol("report.codebook")),
  file = as.list(file.path("reports", "CE-BPatG_Codebook.Rmd")),
  params = as.list(data.frame(output_file = paste0("../output/CE-BPatG_", Sys.Date(), "_Codebook.pdf")))
)



tarchetypes::tar_eval(tarchetypes::tar_render(name, file, params = params), values = values)
