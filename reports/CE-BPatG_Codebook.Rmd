...
Die Richterschaft des Bundespatengerichts unterscheidet sich merklich von der anderer Gerichte, denn in allen Verfahren in denen technischen Erfindungen zu beurteilen sind müssen sowohl Jurist:innen als auch \enquote{technische Richter:innen} mitwirken. Technische Richter:innen müssen ein technisches oder naturwissenschaftliches Studium, 5 Jahre Berufserfahrung in einem technisch-naturwissenschaftlichen Beruf und entsprechende Rechtskenntnisse vorweisen können (§§ 65 Abs. 2 S. 3, 26 Abs. 3 PatG). Nur markenrechtliche Verfahren werden von Jurist:innen alleine geführt.

Insgesamt 99 Richter:innen sind am Bundespatentgericht tätig, davon sind 28 weiblich. Die Richterschaft besteht aus 57 technische Richter:innen und 42 Jurist:innen (Stichtag 31. Dezember 2021). Richter:innen am Bundespatentgericht werden vom Bundespräsidenten auf Lebenszeit ernannt (§ 63 Abs. 3 BPatG).
