...
output:
  pdf_document:
    ...
    includes:
      ...
      before_body: [../temp/CE-BPatG_Definitions.tex, ../tex/CE-BPatG_Titlepage_Codebook.tex]
...
Das **Bundespatentgericht (BPatG)** ist ein speziell für den gewerblichen Rechtsschutz (z.b. Patente und Marken) errichtetes oberes Bundesgericht (Art. 96 Abs. 1 GG). Es ist primär für die Kontrolle von Entscheidungen des Deutschen Patent- und Markenamts und des Bundessortenamts, sowie Nichtigkeitsklagen gegen Patente und für Zwangslizenzverfahren zuständig (§§ 65 Abs. 1 PatG, 34 Abs. 1 SortSchG). Es ist im Instanzenzug der ordentlichen Gerichtsbarkeit nur dem Bundesgerichtshof untergeordnet. \footnote{Die \enquote{ordentliche Gerichtsbarkeit} ist eine historische gewachsene Bezeichnung. Früher war die Verwaltungsgerichtsbarkeit nicht mit unabhängigen Richtern, sondern mit Verwaltungsbeamten besetzt und daher \enquote{außerordentlich}. Die mit unabhängigen Richtern besetzten Gerichte wurden als \enquote{ordentlich} bezeichnet.} Es wurde am 1. Juli 1961 errichtet und hat seinen Sitz in München am Sitz des Deutschen Patent- und Markenamts (§ 65 Abs. 1 PatG). 

Im Jahr 2022 am BPatG eingerichtet sind 24 Senate: ein Juristischer Beschwerdesenat, 6 Nichtigkeitssenate, 10 Technische Beschwerdesenate, 4 Marken-Beschwerdesenate, ein Marken- und Design-Beschwerdesenat, ein Gebrauchsmuster-Beschwerdesenat und ein Beschwerdesenat für Sortenschutzsachen. Die Besetzung der Senate unterscheidet sich je nach Verfahrensart und beträgt zwischen drei und fünf Richter:innen (§ 67 BPatG). 

Die Richterschaft des Bundespatengerichts unterscheidet sich merklich von der anderer Gerichte, denn in allen Verfahren in denen technischen Erfindungen zu beurteilen sind müssen sowohl Jurist:innen als auch \enquote{technische Richter:innen} mitwirken. Technische Richter:innen müssen ein technisches oder naturwissenschaftliches Studium vorweisen können, 5 Jahre Berufserfahrung in einem technisch-naturwissenschaftlichen Beruf erworben haben und entsprechende Rechtskenntnisse besitzen (§§ 65 Abs. 2 S. 3, 26 Abs. 3 PatG). Nur markenrechtliche Verfahren werden alleine von Jurist:innen geführt.

Insgesamt 99 Richter:innen sind am Bundespatentgericht tätig, davon 28 Richterinnen und 71 Richter (Stichtag 31. Dezember 2021). Fachlich aufgeschlüsselt sind es 57 technische Richter:innen und 42 Jurist:innen. Richter:innen am Bundespatentgericht werden vom Bundespräsidenten auf Lebenszeit ernannt (§ 63 Abs. 3 BPatG).
...
```{r, CE-BPatG_00_Pipeline_Graph, width = 12, height = 9}
